...
class NavigationProvider:
    ...
    def set_path(self, path: PathLike) -> None:
        ...
        if not waypoints:
            logger.warning("NavigationProvider.set_path: no waypoints loaded, ignoring")
            return
            ...
            try:
                ...
                if rec is None:
                    ...
                    if mode == "DWA":
                        ...
                        gnss_rec = self._gnss.get_record()
                    ...
                    st = NavigationState(
                        ...
                        vyaw=vyaw,
                        mode=mode,
                        heading_calibrated=bool(rec.heading_calibrated),
                        reached_goal=bool(rec.reached_goal),
                    )
                with self._state_lock:
